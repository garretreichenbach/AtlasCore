...
/**
 * Dialog for editing a specific user's permissions on a specific entity.
 *
 * @author TheDerpGamer
 */
public class BuildSectorEditEntityUserPermissionsDialog extends PlayerInput {
    ...
    @Override
    public BuildSectorEditEntityUserPermissionsPanel getInputPanel() { return panel; }
    ...
    public static class BuildSectorEditEntityUserPermissionsPanel extends GUIInputPanel {
        ...
        public BuildSectorEditEntityUserPermissionsPanel(InputState state, GUICallback guiCallback,
